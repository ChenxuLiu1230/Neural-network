...
#include "../../include/visualizer/sketchpad.h"
...
Sketchpad::Sketchpad(const vec2& top_left_corner, size_t num_pixels_per_side,
  ...
  pixels = vector<vector<bool>> (num_pixels_per_side, vector<bool>(num_pixels_per_side, false));
}
...
void Sketchpad::Clear() {
  pixels = vector<vector<bool>> (num_pixels_per_side_, vector<bool>(num_pixels_per_side_, false));
}
